...
<html lang="en">
  ...
  <body>
  <div>
  <h3 class="text-center mb-3"><u>Professor Details</u></h3>
      </div>
  <div>
  <?php
              ...
              <table id="student" class="table-hover" align="center"> 
                    <tr class="columns" style="border: 1px solid black;background-color:#f2f2f2;"> 
                        ...
                        <th class="text-center px-3 py-2"> <font face="Arial">College ID number </font> </th> 
                        ...
                        <th class="text-center px-4 py-2"> <font face="Arial">Venue</font> </th> 
                        <th class="text-center px-5 py-2"> <font face="Arial">Stage</font> </th> 
                        <th class="text-center px-3 py-2"> <font face="Arial">Academic Year</font> </th> 
                        <th class="text-center px-5 py-2"> <font face="Arial">Date</font> </th> 
                        <th class="text-center px-4 py-2"> <font face="Arial">ISBN</font> </th> 
