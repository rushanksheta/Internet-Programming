...
$sql = "INSERT INTO student( First_name , Last_name, College_ID_number , Year, Department, Title,
 Conference , Venue , Stage , Academic_Year , DATE , ISBN , Start_page_number , End_page_number , Link, file_name)
VALUES ('$_POST[fname]','$_POST[lname]','$_POST[id]','$_POST[year]','$_POST[dept]','$_POST[title]','$_POST[conf]','$_POST[venue]',
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-center flex-wrap">
            ...
            <a href="../php/view_s.php" class="btn btn-primary bg-secondary mt-2 ml-2" role="button">View Research Paper Details</a>
            </div>
            
            <div>
                <a href="../index.php" class="btn btn-primary bg-secondary mt-2 ml-2" role="button">Back to Home Page</a>
